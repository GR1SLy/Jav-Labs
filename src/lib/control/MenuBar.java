...
public class MenuBar extends JMenuBar {
    ...
    private JMenuItem _startItem, _stopItem, _showTimerItem, _showInfoItem, _objectsItem;
...

    {
        ...
        _objectsItem = new JMenuItem("Current objects");
        _objectsItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                _habitat._controlPanel._objectsButton.doClick();
            }
        });
        _headMenu.add(_objectsItem);
