...
import com.lab.lib.net.ClientFrame;
...
public class MenuBar extends JMenuBar {
    ...
    private JMenuItem _startItem, _stopItem, _showTimerItem, 
                      ...
                      _consoleItem, _clientItem, _DBItem, _fDBItem;
...

    {
        ...
        _DBItem = new JMenuItem("Save in DB");
        _DBItem.addActionListener(e -> {
                _habitat.saveDataInDB();
        });
        _fileMenu.add(_DBItem);

        _fDBItem = new JMenuItem("Load from DB");
        _fDBItem.addActionListener(e -> {
                _habitat.loadDataFromDB();
        });
        _fileMenu.add(_fDBItem);
